...
Os dados foram extraídos do site do Kaggle: <"[https://www.kaggle.com/datasets/whenamancodes/students-performance-in-exams?select=exams.csv]">Desempenho dos alunos nos exames</a>
